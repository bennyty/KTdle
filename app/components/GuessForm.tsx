...
export default function GuessForm({ submitGuess, operativeNames }: GuessFormProps) {
  return (
    <form action={submitGuess}
      ...
      <input type="text"
        ...
        className="flex-grow w-full rounded box-border border border-gray-300 px-4 py-2 focus:border-blue-500 focus:outline-none"
      />
